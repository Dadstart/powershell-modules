@{
    ...
    Description = 'PowerShell module for media ripping and extraction tools.'
    ...
    PrivateData = @{
        PSData = @{
            ...
            Tags = @('Rip', 'Media', 'Extraction', 'DVD', 'BluRay')
            ...
            ReleaseNotes = 'Initial placeholder for Rip module'
